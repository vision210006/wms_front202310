...
export const getStoreStatus = async () => {
    ...
    const data = await getPromise(`http://localhost:8080/api/v2/contract/store-contracts`, option, ).catch(() => {
    // const data = await getPromise(`http://222.98.255.30:23233/api/v2/contract/store-contracts`, option, ).catch(() => {
        return statusError;
    });
